...
null == o && ((o = function (e) {
    ...
    ,
    t.parcelRequire3a9a = o);
var r = o("1Emd6")
    , a = o("3HIuf")
    , s = {};
s = new URL(o("27Lyk").resolve("gGDRF"), import.meta.url).toString();
var l = {};
l = new URL(o("27Lyk").resolve("QTDDy"), import.meta.url).toString();
var c = {};
c = new URL(o("27Lyk").resolve("lbtD9"), import.meta.url).toString();
var u = {};
u = new URL(o("27Lyk").resolve("iOvDh"), import.meta.url).toString(),
    e(r).registerPlugin(e(a));
const d = e => window.innerWidth * (e / 100)
    , p = e => window.innerHeight * (e / 100);
let f = e(r).utils.clamp(1, 5);
e(r).set(".main__description-span", {
    opacity: .2
}),
    e(a).matchMedia({
        "(min-width: 1025px)": () => {
            e(a).create({
                onUpdate: e => {
                    let t = f(Math.abs(e.getVelocity() / 200));
                    document.querySelector(".main__video").playbackRate = t
                }
            });
            let t = e(r).timeline({
                scrollTrigger: {
            ...
            e(r).set(".main-section", {
                height: p(100)
            }),
                e(r).set(".main-section_second-content", {
                    position: "absolute",
                    bottom: p(20),
                    columnGap: "30vw"
                }),
                e(r).set(".main__image_wrapper", {
                    xPercent: -100,
                    opacity: 0
                }),
                e(r).set(".main-section_second-content", {
                ...
                t.to(".main__name-span", {
                    marginLeft: d(-11.979)
                }, "<"),
                t.to(".main__image_wrapper", {
                    xPercent: 0,
                    opacity: 1
                }, "<"),
                t.to(".main-section_first-content", {
                    x: "100vw"
                }),
                t.to(".main__image_wrapper", {
                    maxHeight: "70vh"
                }, "<0.2"),
                t.to(".main-section_second-content", {
                    columnGap: "20vw",
                    zIndex: 1
                }, "<"),
                t.to(".main__description", {
                    opacity: 1
                }, "<"),
                n.to(".main__description-span", {
                    opacity: 1,
                    stagger: .2
                }, ">40"),
                n.to(".main__image", {
...
x = function (e) {
            ...
            o.update = function (e, t) {
                ...
                for (var f = 0; f < e.parts.length; f++) {
                    ...
                    r.translate(v.vertices, e.velocity),
                        ...
                        0 !== e.angularVelocity && (r.rotate(v.vertices, e.angularVelocity, e.position),
                            u.rotate(v.axes, e.angularVelocity),
                            f > 0 && a.rotateAbout(v.position, e.angularVelocity, e.position, v.position)),
        ...
        i = [],
            ...
            a.collides = function (e, t, n) {
                ...
                var d = c.normal
                    ...
                    , v = f.x
                    , m = f.y;
                v * (t.position.x - e.position.x) + m * (t.position.y - e.position.y) < 0 ? (d.x = v,
                    d.y = m) : (d.x = -v,
                        d.y = -m),
                    c.tangent.x = -d.y,
                    c.tangent.y = d.x,
                ...
                var y = a._findSupports(e, t, d, 1)
                    , g = 0;
                if (s.contains(e.vertices, y[0]) && (p[g++] = y[0]),
                    s.contains(e.vertices, y[1]) && (p[g++] = y[1]),
                    g < 2) {
            ...
            a._overlapAxes = function (e, t, n, i) {
                var o, r, a, s, l, c, u = t.length, d = n.length, p = t[0].x, f = t[0].y, v = n[0].x, m = n[0].y, y = i.length, g = Number.MAX_VALUE, x = 0;
                for (l = 0; l < y; l++) {
                    var h = i[l]
                        , b = h.x
                        , S = h.y
                        ...
                        , A = P;
                    for (c = 1; c < u; c += 1)
                        (s = t[c].x * b + t[c].y * S) > _ ? _ = s : s < w && (w = s);
                    for (c = 1; c < d; c += 1)
                        (s = n[c].x * b + n[c].y * S) > A ? A = s : s < P && (P = s);
                    if ((o = (r = _ - P) < (a = A - w) ? r : a) < g && (g = o,
                        x = l,
                        o <= 0))
                        break
                }
            ...
            a._findSupports = function (e, t, n, o) {
                var r, a, s, l, c, u = t.vertices, d = u.length, p = e.position.x, f = e.position.y, v = n.x * o, m = n.y * o, y = Number.MAX_VALUE;
                for (c = 0; c < d; c += 1)
                    (l = v * (p - (a = u[c]).x) + m * (f - a.y)) < y && (y = l,
                        r = a);
                return (y = v * (p - (s = u[(d + r.index - 1) % d]).x) + m * (f - s.y),
                    v * (p - (a = u[(r.index + 1) % d]).x) + m * (f - a.y) < y) ? (i[0] = r,
                        i[1] = a) : (i[0] = r,
                            i[1] = s),
                    i
            }
            ...
            i.solve = function (e, t) {
                ...
                if (n || o) {
                    ...
                    if (n && (l = r.add(n.position, a)),
                        ...
                        var p, f, v, m, y, g = (d - e.length) / d, x = e.stiffness >= 1 || 0 === e.length ? e.stiffness * t : e.stiffness * t * t, h = e.damping * t, b = r.mult(u, g * x), S = (n ? n.inverseMass : 0) + (o ? o.inverseMass : 0), w = S + ((n ? n.inverseInertia : 0) + (o ? o.inverseInertia : 0));
                        if (h > 0) {
                            var P = r.create();
                            v = r.div(u, d),
                                y = r.sub(o && r.sub(o.position, o.positionPrev) || P, n && r.sub(n.position, n.positionPrev) || P),
                                m = r.dot(v, y)
                        }
                        n && !n.isStatic && (f = n.inverseMass / S,
                            ...
                            n.position.x -= b.x * f,
                            n.position.y -= b.y * f,
                            h > 0 && (n.positionPrev.x -= h * v.x * m * f,
                            ...
                            o && !o.isStatic && (f = o.inverseMass / S,
                                ...
                                o.position.x += b.x * f,
                                o.position.y += b.y * f,
                                h > 0 && (o.positionPrev.x += h * v.x * m * f,
                                    o.positionPrev.y += h * v.y * m * f),
    ...
    , function (e, t, n) {
        ...
        i.rectangle = function (e, t, n, i, s) {
            ...
            i.fromVertices = function (e, t, n, i, c, u, d, p) {
                var f, v, m, y, g, x, h, b, S, w, P = r.getDecomp();
                for (f = !!(P && P.quickDecomp),
                    ...
                    if (g = n[S],
                        ...
                        P.makeCCW(_),
                            !1 !== u && P.removeCollinearPoints(_, u),
                            !1 !== p && P.removeDuplicatePoints && P.removeDuplicatePoints(_, p);
                        var A = P.quickDecomp(_);
                        for (x = 0; x < A.length; x++) {
                            var C = A[x].map(function (e) {
                                return {
                                    x: e[0],
                                    y: e[1]
                                }
                ...
                if (c)
                    for (x = 0; x < m.length; x++) {
                        ...
                        for (h = x + 1; h < m.length; h++) {
                            var k = m[h];
                            if (s.overlaps(M.bounds, k.bounds)) {
                                var B = M.vertices
                                    , I = k.vertices;
                                for (b = 0; b < M.vertices.length; b++)
                                    for (w = 0; w < k.vertices.length; w++) {
                                        var T = l.magnitudeSquared(l.sub(B[(b + 1) % B.length], I[w]))
                                            , R = l.magnitudeSquared(l.sub(B[b], I[(w + 1) % I.length]));
                                        T < 5 && R < 5 && (B[b].isInternal = !0,
                                            I[w].isInternal = !0)
                                    }
                            }
                        }
            ...
            i.collisions = function (e) {
                ...
                for (s.sort(i._compareBoundsX),
                    ...
                    for (n = t + 1; n < l; n++) {
                        ...
                        if (b.min.x > f)
                            break;
                        if (!(v < b.min.y) && !(m > b.max.y) && (!y || !h.isStatic && !h.isSleeping) && c(d.collisionFilter, h.collisionFilter)) {
                            var S = h.parts.length;
                            if (x && 1 === S) {
                                var w = u(d, h, a);
                                w && o.push(w)
                            } else
                                for (var P = g > 1 ? 1 : 0, _ = S > 1 ? 1 : 0, A = P; A < g; A++)
                                    for (var C = d.parts[A], p = C.bounds, M = _; M < S; M++) {
                                        var k = h.parts[M]
                                            , b = k.bounds;
                                        if (!(p.min.x > b.max.x) && !(p.max.x < b.min.x) && !(p.max.y < b.min.y) && !(p.min.y > b.max.y)) {
                                            var w = u(C, k, a);
                                            w && o.push(w)
                                        }
                                    }
    ...
    , function (e, t, n) {
        ...
        i.create = function (e) {
            ...
            ,
            i.update = function (e, t) {
                var n, p = d.now(), f = e.world, v = e.detector, m = e.pairs, y = e.timing, g = y.timestamp;
    ...
    , function (e, t, n) {
        ...
        i._restingThresh = 2,
            ...
            i.solvePosition = function (e, t, n) {
                var o, a, s, l, c, u, d, p, f = i._positionDampen * (n || 1), v = r.clamp(t / r._baseDelta, 0, 1), m = e.length;
                for (o = 0; o < m; o++)
                ...
                for (a = 0; a < v; a++) {
                    ...
                    if (m.isActive && !m.isSensor) {
                        var y = m.collision
                            ...
                            , C = A.length
                            , M = 1 / C
                            , k = g.inverseMass + x.inverseMass
                            , B = m.friction * m.frictionStatic * p;
                        for (s = 0,
                            ...
                            x.angularVelocity = x.angle - x.anglePrev; s < C; s++) {
                            var I = A[s]
                                , T = I.vertex
                                , R = T.x - g.position.x
                                , L = T.y - g.position.y
                                , V = T.x - x.position.x
                                , D = T.y - x.position.y
                                , E = h.x - L * g.angularVelocity
                                , H = h.y + R * g.angularVelocity
                                , O = b.x - D * x.angularVelocity
                                , W = b.y + V * x.angularVelocity
                                , q = E - O
                                , F = H - W
                                , U = S * q + w * F
                                , j = P * q + _ * F
                                ...
                                , N = (z = G < 0 ? 0 : z) * B;
                            j < -N || j > N ? (o = j > 0 ? j : -j,
                                (n = m.friction * (j > 0 ? 1 : -1) * c) < -o ? n = -o : n > o && (n = o)) : (n = j,
                                    o = f);
                            var Q = R * w - L * S
                                , X = V * w - D * S
                                , Y = M / (k + g.inverseInertia * Q * Q + x.inverseInertia * X * X)
                            ...
                            var K = S * Z + P * n
                                , ee = w * Z + _ * n;
                            g.isStatic || g.isSleeping || (g.positionPrev.x += K * g.inverseMass,
                                g.positionPrev.y += ee * g.inverseMass,
                                g.anglePrev += (R * ee - L * K) * g.inverseInertia),
                                x.isStatic || x.isSleeping || (x.positionPrev.x -= K * x.inverseMass,
                                    x.positionPrev.y -= ee * x.inverseMass,
                                    x.anglePrev -= (V * ee - D * K) * x.inverseInertia)
                        }
                    }
                }
            }
            ...
            i.update = function (e, t, n) {
                ...
                for (s = 0,
                    ...
                    (a = l[s]).confirmedActive || (o.setActive(a, !1, n),
                        f.push(a),
                        a.collision.bodyA.isSleeping || a.collision.bodyB.isSleeping || m.push(s));
                            ...
                            for (a = m.startCol; a <= m.endCol; a++)
                                for (s = m.startRow; s <= m.endRow; s++) {
                                    ...
                                    !y && g && g && l && i._bucketRemoveBody(e, l, f),
                                        (f.region === v || y && !g || o) && (l || (l = i._createBucket(d, c)),
        ...
        "undefined" != typeof window && (i = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function (e) {
            ...
            d.lookAt = function (e, t, n, i) {
                ...
                v > p ? y = v / p : m = p / v,
                    ...
                    e.bounds.max.x = o.min.x + c * m,
                    e.bounds.min.y = o.min.y,
                    e.bounds.max.y = o.min.y + u * y,
                    i && (e.bounds.min.x += .5 * c - c * m * .5,
                        e.bounds.max.x += .5 * c - c * m * .5,
            ...
            d.world = function (e, t) {
                var n, i = f.now(), o = e.engine, r = o.world, a = e.canvas, s = e.context, l = e.options, c = e.timing, p = v.allBodies(r), h = v.allConstraints(r), b = l.wireframes ? l.wireframeBackground : l.background, S = [], w = [], P = {
                    timestamp: o.timing.timestamp
                };
                if (y.trigger(e, "beforeRender", P),
                    ...
                    for (n = 0; n < p.length; n++) {
                        var _ = p[n];
                        m.overlaps(_.bounds, e.bounds) && S.push(_)
                    }
                    for (n = 0; n < h.length; n++) {
                        var A = h[n]
                            ...
                            , k = A.pointA
                            , B = A.pointB;
                        C && (k = g.add(C.position, A.pointA)),
                            M && (B = g.add(M.position, A.pointB)),
                            k && B && (m.contains(e.bounds, k) || m.contains(e.bounds, B)) && w.push(A)
                    }
                ...
                !l.wireframes || o.enableSleeping && l.showSleeping ? d.bodies(e, S, s) : (l.showConvexHulls && d.bodyConvexHulls(e, S, s),
                    ...
                    y.trigger(e, "afterRender", P),
                    c.lastElapsed = f.now() - i
            }
            ,
            d.stats = function (e, t, n) {
                for (var i = e.engine, o = i.world, r = v.allBodies(o), a = 0, s = 0, l = 0; l < r.length; l += 1)
                    a += r[l].parts.length;
                var c = {
                    Part: a,
                    Body: r.length,
            ...
            d.performance = function (e, t) {
                ...
                t.fillStyle = "#0e0f19",
                    ...
                    d.status(t, 10, 69, 60, 4, o.length, Math.round(g) + " fps", g / d._goodFps, function (e) {
                        return o[e] / p - 1
                    }),
                    d.status(t, 82, 69, 60, 4, l.length, u.toFixed(2) + " dt", d._goodDelta / u, function (e) {
                        return l[e] / v - 1
                    }),
                    d.status(t, 154, 69, 60, 4, c.length, m.toFixed(2) + " ut", 1 - m / d._goodFps, function (e) {
                        return c[e] / m - 1
                    }),
                    d.status(t, 226, 69, 60, 4, r.length, f.toFixed(2) + " rt", 1 - f / d._goodFps, function (e) {
                        return r[e] / f - 1
                    }),
                    d.status(t, 298, 69, 60, 4, s.length, y.toFixed(2) + " x", y * y * y, function (e) {
                        return (s[e] / o[e] / y || 0) - 1
                    })
            }
            ,
            ...
            d.bodyBounds = function (e, t, n) {
                ...
                for (var o = 0; o < t.length; o++)
                    if (t[o].render.visible)
                        for (var r = t[o].parts, a = r.length > 1 ? 1 : 0; a < r.length; a++) {
                            var s = r[a];
            ...
            d.bodyAxes = function (e, t, n) {
                ...
                for (n.beginPath(),
                    ...
                    if (l.render.visible) {
                        if (s.showAxes)
                            for (r = c.length > 1 ? 1 : 0; r < c.length; r++)
                                for (a = 0,
            ...
            d.bodyIds = function (e, t, n) {
                ...
                for (i = 0; i < t.length; i++)
                    if (t[i].render.visible) {
                        var r = t[i].parts;
                        for (o = r.length > 1 ? 1 : 0; o < r.length; o++) {
                            var a = r[o];
                            n.font = "12px Arial",
            ...
            d.collisions = function (e, t, n) {
                ...
                for (n.beginPath(),
                    ...
                    if ((i = t[r]).isActive)
                        for (a = 0,
                            o = i.collision; a < i.activeContacts.length; a++) {
                            var l = i.activeContacts[a].vertex;
                ...
                for (s.wireframes ? n.fillStyle = "rgba(255,255,255,0.7)" : n.fillStyle = "orange",
                    ...
                    if ((i = t[r]).isActive && (o = i.collision,
                        ...
                        2 === i.activeContacts.length && (c = (i.activeContacts[0].vertex.x + i.activeContacts[1].vertex.x) / 2,
    ...
    , function (e, t, n) {
        ...
        i.pathToVertices = function (e, t) {
            ...
            var n, r, a, s, l, c, u, d, p, f, v, m = [], y = 0, g = 0, x = 0;
            t = t || 15;
...
var h = {};
h = new URL(o("27Lyk").resolve("ajMb2"), import.meta.url).toString();
var b = {};
b = new URL(o("27Lyk").resolve("5E2cL"), import.meta.url).toString();
var S = {};
S = new URL(o("27Lyk").resolve("leVhW"), import.meta.url).toString();
var w = {};
w = new URL(o("27Lyk").resolve("dFPf0"), import.meta.url).toString();
var P = {};
P = new URL(o("27Lyk").resolve("iTh5S"), import.meta.url).toString();
var _ = {};
_ = new URL(o("27Lyk").resolve("fU3SR"), import.meta.url).toString();
var A = {};
A = new URL(o("27Lyk").resolve("7z8Gn"), import.meta.url).toString();
var C = {};
C = new URL(o("27Lyk").resolve("8TTeV"), import.meta.url).toString();
var M = {};
M = new URL(o("27Lyk").resolve("eyL7P"), import.meta.url).toString();
var k = {};
k = new URL(o("27Lyk").resolve("2JU2Q"), import.meta.url).toString();
var B = {};
B = new URL(o("27Lyk").resolve("isi5v"), import.meta.url).toString();
var I = {};
I = new URL(o("27Lyk").resolve("8cIQY"), import.meta.url).toString();
var T = {};
T = new URL(o("27Lyk").resolve("4DOLg"), import.meta.url).toString();
let R = document.querySelector(".services__matter-js")
    , L = e(x).Engine
    , V = e(x).Render
    , D = e(x).Runner
    , E = e(x).Bodies
    ...
    , K = E.rectangle(R.clientWidth / 2, R.clientHeight + 100, 1e4, 200, {
        isStatic: !0,
        render: {
            lineWidth: 0,
            strokeStyle: "#000000"
    ...
    , ee = E.rectangle(R.clientWidth + 100, R.clientHeight, 200, 10 * R.clientHeight, {
        isStatic: !0,
        render: {
            lineWidth: 0,
            strokeStyle: "#000000"
    ...
    , et = E.rectangle(-100, R.clientHeight / 2, 200, 10 * R.clientHeight, {
        isStatic: !0,
        render: {
            lineWidth: 0,
            strokeStyle: "#000000"
    ...
    , en = e(x).Mouse.create(W.canvas)
    , ei = e(x).MouseConstraint.create(O, {
        mouse: en,
        constraint: {
            stiffness: .2,
            render: {
...
H.add(O.world, [K, ee, et, ei]),
    H.add(O.world, [q, F, U, j, G, z, N, Q, X, Y, Z, $, J]),
    V.run(W);
let eo = D.create();
window.addEventListener("resize", () => {
    W.canvas.width = R.clientWidth,
        W.canvas.height = R.clientHeight,
        e(x).Body.setPosition(K, e(x).Vector.create(R.clientWidth / 2, R.clientHeight + 100)),
        e(x).Body.setPosition(ee, e(x).Vector.create(R.clientWidth + 100, R.clientHeight / 2))
}
),
    en.element.removeEventListener("mousewheel", en.mousewheel),
    en.element.removeEventListener("DOMMouseScroll", en.mousewheel);
let er = new IntersectionObserver((e, t) => {
    e.forEach(e => {
        e.isIntersecting && (D.run(eo, O),
            t.unobserve(R))
    }
    )
}
...
var ea = o("gexHD")
    , es = o("VsODs");
let el = new IntersectionObserver(function (e, t) {
    e.forEach(function (e) {
        e.isIntersecting && e.target.timeline.play()
    })
}
    , {
        threshold: 1
    })
    , ec = document.querySelectorAll(".text-up_animation__wrapper");
var eu = o("kTnAw")
    , ed = o("aY5wY")
    , ep = o("S4my2");
(0,
    v.initScrollSmoother)(),
    (0,
        m.timeInit)(),
    (0,
        y.initProgressBar)(),
    ...
    (0,
        ea.initAttractHover)(),
    (0,
        es.init3DHoverEffect)(),
    (() => {
        gsap.set(".text-up_animation", {
            yPercent: 100
        });
        let e = gsap.timeline({
            paused: !0
        });
        e.to(".text-up_animation", {
            yPercent: 0,
            duration: 1
        }),
            ec.forEach(t => {
    ...
    (0,
        ep.initScrollTo)();
//# sourceMappingURL=index.448c596b.js.map
